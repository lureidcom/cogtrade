...
import com.cogtrade.block.TradePostBlockEntity;
...
public class TradePostBlockEntityRenderer implements BlockEntityRenderer<TradePostBlockEntity> {

    private static final int    LABEL_COLOR = 0xFF55FFFF; // aqua
    private static final int    LABEL_SEE   = 0x6055FFFF;
    ...
    public TradePostBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {
        this.textRenderer = ctx.getTextRenderer();
        this.dispatcher   = ctx.getEntityRenderDispatcher();
    }

    @Override
    public void render(TradePostBlockEntity entity, float tickDelta, MatrixStack matrices,
        ...
        String label = "✦ " + ownerName + "'in Pazarı ✦";
    ...
    @Override
    public boolean rendersOutsideBoundingBox(TradePostBlockEntity blockEntity) {
        return true;
    }
}